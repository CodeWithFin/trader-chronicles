/** Shown in API responses and the Trading Accounts UI until Neon is migrated. */
export const TRADING_ACCOUNTS_MIGRATION_HELP =
  'Database setup required: in Neon, open SQL Editor and run the script from neon/migrations/001_trading_accounts.sql in this repository (or apply neon/schema.sql on a fresh database). Then refresh this page.'

...
-- Backtesting module: strategy backtests kept fully separate from normal trades.
-- (public.backtest_entries above holds normal/live trades despite its legacy name.)

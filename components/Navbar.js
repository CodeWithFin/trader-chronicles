    ...
    <nav className="w-full border-b-2 border-black bg-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/dashboard" className="flex items-center gap-2 group cursor-pointer shrink-0" onClick={closeMobileMenu}>
          <div className="logo-chip p-0.5 border-2 border-black rounded-sm overflow-hidden shadow-brutal-sm flex items-center justify-center shrink-0">
            <Image src="/tagged.png" alt="Logo" width={28} height={28} className="block object-contain" />
          </div>
          <span className="text-xl font-bold tracking-tight whitespace-nowrap">Trader Chronicles</span>
        </Link>
        ...
        <div className="flex items-center gap-4 ml-6 md:ml-10">
          {session ? (
            ...
            <Link
              href="/trades/new"
              className="flex items-center justify-center gap-2 whitespace-nowrap shrink-0 px-5 py-2 border-2 border-black bg-white text-sm font-semibold hover:bg-zinc-100 transition-colors shadow-brutal-md active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center whitespace-nowrap shrink-0 px-5 py-2 border-2 border-black bg-orange-600 text-white text-sm font-semibold hover:bg-orange-500 transition-colors shadow-brutal-md active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
              Logout
            </button>
            </div>
            ...
            <Link
              href="/login"
              className="px-5 py-2 border-2 border-black bg-white text-sm font-semibold hover:bg-zinc-100 transition-colors shadow-brutal-md active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
              Login
            </Link>
            <Link
              href="/signup"
              className="px-5 py-2 border-2 border-black bg-orange-600 text-white text-sm font-semibold hover:bg-orange-500 transition-colors shadow-brutal-md active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
            >
              Sign Up
            </Link>
            </div>
          ...
          <button
            type="button"
            className="md:hidden p-2 border-2 border-black bg-white hover:bg-zinc-100 transition-colors shadow-brutal-sm active:shadow-none active:translate-x-[1px] active:translate-y-[1px]"
      ...
      {menuOpen && (
        <div className="md:hidden fixed inset-0 z-50" aria-hidden={!menuOpen}>
          ...
          <div
            id="mobile-menu"
            className="absolute top-0 right-0 h-full w-[85%] max-w-sm border-l-4 border-black bg-white p-6 overflow-y-auto shadow-brutal-drawer"
          >

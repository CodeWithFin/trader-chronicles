    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-16">
        <section className="w-full relative mb-20">
          <div className="w-full border-4 border-black p-6 md:p-16 shadow-brutal-2xl relative overflow-hidden bg-white">
        ...
        <section className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6">
          <Link href="/trades/new" className="group relative">
            <div className="absolute -top-3 -left-3 bg-white border-2 border-black px-2 py-1 z-20 text-xs font-bold shadow-brutal-sm">
              ACTION 01
            </div>
            <div className="h-full border-2 border-black bg-white p-8 shadow-brutal-xl transition-all group-hover:-translate-y-1 group-hover:shadow-brutal-2xl flex flex-col">
          ...
          <Link href="/trades" className="group relative md:-mt-4">
            ...
            <div className="h-full border-2 border-black bg-orange-600 text-white p-8 shadow-brutal-xl transition-all group-hover:-translate-y-1 group-hover:shadow-brutal-2xl flex flex-col relative overflow-hidden">
